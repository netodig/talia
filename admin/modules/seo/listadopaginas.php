...
<?php 
  ...
  $seoList=$seo->getListadoPaginas($limit);
  ...
  <div class="tablediv">
    <table width="100%" border="0" cellspacing="0">
      ...
      <tr class="<?php echo $par ?>" id="row<?php echo $c->g('id') ?>">
        ...
        <td><?php echo htmlentities($c->g('descripcion')) ?></td>
        <td><a href="<?php echo Url::adminlink("seo/editpagina","cid=".$c->g('idss')."&cidtipo=".$c->g('id')) ?>" class="mod"></a></td>
      </tr>
      <?php
		if(!$par)
		$par="par";
